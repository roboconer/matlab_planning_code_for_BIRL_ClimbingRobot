...
%这份正运动学的代码是以弓形作为零状态（joint_ang = [0,0,0,0,0]）的
%零状态：G0在G6的左边，机器人呈弓形（I1平行于I2，T2后半、T3、T4前半在一条直线上）
...
% T_TrackingRing_4 = [cos(joi(5)) -sin(joi(5)) 0 0;0 0 -1 - (Len(4)-137);sin(joi(5)) cos(joi(5)) 0 0;0 0 0 1];
if option == 1%T_b_2
    T = T_1b*T_21;
    joi_p = T(1:3,4)';
...
elseif option == 4%T_b_5
    ...
    joi_p = T(1:3,4)';
% elseif option == 5%T_b_TrackingRing
%     T = T_1b*T_21*T_32*T_43*T_TrackingRing_4;
%     joi_p = T(1:3,4)';
else
