function [lastbas_R,laststp_R,lastjoi,joint_ang] = colli_avoidance33( M_sur,stp,enp,bap,obs_p,bas_R,stp_R,fir_joi,so_option)
...
if num_ob >0
     for i = 1:num_ob 
      ...
      if state(num_ang-4) == 0
          if so_option == 1
           %   break;
              [lastbas_R,laststp_R,lastjoi,joint_ang] = colli_avoidance33( M_sur,stp_o,enp_o,bap_o,obs_p2,bas_R,stp_R,fir_joi,2);
              return;
          else
