function [lastbas_R,laststp_R,lastjoi,joint_ang ] = colli_avoidance_walls( M_sur,stp,enp,bap,obs_p,bas_R,stp_R,fir_joi,so_option)
...
dis = 10000;
TO_SURFACE_DISTANCE = 0.35;%单步规划时，吸盘抬起的距离
vec_lin = zeros(1,3);
vec_eff = zeros(1,3);
...
%//////////////////////////////// end
num_ang = TO_SURFACE_DISTANCE * 100;
i = 0;

stp = stp + close_vector;
wrobot.TarGraspMtx(1:3,4) = (stp')*1000;
...
%        T(1:3,3) = T(1:3,3)*-1; 
      ...
      wrobot.CurJAs=joint_ang(num_ang+i-1,:);
       ...
       if Flag == 0 
            ...
            num_ang = num_ang - TO_SURFACE_DISTANCE * 100 - 1;
        uiwait(h,2);
        break;
       end
 end
