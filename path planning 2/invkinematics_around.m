 %%%%%%%%%%尺蠖式、扭转式攀爬步态      
 function [a1,a2,a3,a4,a5]=invkinematics_around(r11,r12,r13,px,r21,r22,r23,py,r31,r32,r33,pz)
    ...
    for i=1:2
        for j=1:2     
             ...
             if abs(b3(j))>pi/2
                ...
                if  abs(b3(j))<=pi/2+10^(-5)&&abs(b4(j)+pi/2)<=pi/2+10^(-5)&&abs(b2+pi/2)<=pi+10^(-5)&&abs(b2)<=a2
